...
Example: Payment_Method → Credit Card, PayPal → two separate columns
...
Part A: Normalization
    ...
    Create dataset using a dictionary.
    Apply Min-Max scaling to selected columns.
    Perform Z-Score normalization.
    Apply Decimal Scaling.
    Normalize multiple columns simultaneously.
    Load external dataset and repeat steps.
    Verify outputs.
...
Part B: Encoding
    ...
    Apply Dummy Encoding with drop_first=True.
    Load student dataset and repeat encoding.
